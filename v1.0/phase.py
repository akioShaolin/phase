...
class LoadCalculatorApp:
    ...
    def create_ui(self):
        ...
        self.loads_tree = ttk.Treeview(loads_list_frame, columns=('Nome', 'Potência', 'Condutores', 'Corrente'), show='headings')
        self.loads_tree.heading('Nome', text='Nome')
        self.loads_tree.heading('Potência', text='Potência (W)')
        self.loads_tree.heading('Condutores', text='Condutores')
        ...
        self.loads_tree.column('Condutores', width=80)
